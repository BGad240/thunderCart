...
const Header = () => {
    ...
    return (
        <header className='sticky top-0 bg-[white]  z-[100] w-[100%] flex-header h-[70px] px-[20px] border-b-1 border-gray-400/20 items-start sm:justify-start'>
            ...
            <nav className={`${isOpen ? "block" : "hidden sm:flex"}  flex-col sm:flex-row justify-between items-center absolute left-0 top-[100%] sm:relative sm:top-0 w-[100%] sm:max-w-[70%] gap-[20px] text-orange-600 sm:text-[#252525] bg-white py-[20px] sm:py-[0] duration-300 transition-all`}>
